...
namespace Planner.API.Migrations
{
    ...
    [Migration("20230909164447_addHasData")]
            ...
            modelBuilder.Entity("Planner.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3b05b8af-0623-4527-8df8-f06c6836efed"),
                            Created = new DateTime(2023, 9, 9, 16, 44, 47, 871, DateTimeKind.Utc).AddTicks(3160),
